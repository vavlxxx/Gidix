...
## Сидирование данных
При первом запуске автоматически создаются учетные записи администратора и менеджера, а также
демонстрационные маршруты и заявки для Уфы.
...
Давай сделаем так, чтобы дату экскурсии для отзыва можно было выбирать из сетки блоков, а не списка select. Также когда отзывв оствляется нужно обязательно ждать одобрения от администрации-менеджера, чтобы он попал и отображался для этой экскурсии