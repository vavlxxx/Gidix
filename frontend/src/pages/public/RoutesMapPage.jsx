  ...
  return (
    <div className="map-page">
      <PageHeader
        ...
        title="Маршрут как управляемый объект"
        description="Выберите экскурсию слева: карта подсветит линию маршрута, старт, финиш и точки интереса. OSRM-геометрия используется как основная, ручной порядок остаётся видимым."
      />
